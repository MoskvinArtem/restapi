jQuery(function($){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://restapi.loc/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://restapi.loc/api/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://restapi.loc/api/product/update.php",
            type : "POST",
